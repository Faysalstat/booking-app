...
public class JwtService {
    ...
    public String generateToken(UserCredential userCredential) {
        ...
        claims.put("userType", userCredential.getUserType());  // Adding user roles
        claims.put("userName", userCredential.getUsername());
        return createToken(claims, userCredential.getUsername());
    }
    ...
    private String createToken(Map<String, Object> claims, String userName) {
        return Jwts.builder()
                ...
                .setExpiration(new Date(System.currentTimeMillis() + 1000 * 60 * 60))  //Expiration for 1 hour
